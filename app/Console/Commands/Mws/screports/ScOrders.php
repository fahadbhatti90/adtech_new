...
class ScOrders extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'ScOrders:cron';
    ...
    public function handle()
    {
        ...
        Log::info("filePath:app\Console\Commands\Mws\screports\ScOrders.php.Download Sales-ScOrders(_GET_FLAT_FILE_ALL_ORDERS_DATA_BY_ORDER_DATE_). Start Cron.");
        MWSModel::insert_mws_Activity('Start Cron.', 'Download Sales-ScOrders(_GET_FLAT_FILE_ALL_ORDERS_DATA_BY_ORDER_DATE_)', 'app\Console\Commands\Mws\screports\ScOrders.php');
        $APIParametr = new MWSModel();
        $api_data = $APIParametr->get_merchants();
        if ($api_data) {
            Log::info("filePath:app\Console\Commands\Mws\screports\ScOrders.php.Download Sales-ScOrders(_GET_FLAT_FILE_ALL_ORDERS_DATA_BY_ORDER_DATE_). Merchants Found.");
            MWSModel::insert_mws_Activity('Merchants Found.', 'Download Sales-ScOrders(_GET_FLAT_FILE_ALL_ORDERS_DATA_BY_ORDER_DATE_)', 'app\Console\Commands\Mws\screports\ScOrders.php');
            foreach ($api_data as $api_parameter) {
                ...
                $getMwsDoneReportsArray = MWSModel::get_mws_done_reports('_GET_FLAT_FILE_ALL_ORDERS_DATA_BY_ORDER_DATE_', $mws_config_id, 'Sales');
                if ($getMwsDoneReportsArray) {
                    Log::info("filePath:app\Console\Commands\Mws\screports\ScOrders.php.Download Sales-ScOrders(_GET_FLAT_FILE_ALL_ORDERS_DATA_BY_ORDER_DATE_). Done Reports Found.");
                    MWSModel::insert_mws_Activity('Done Reports Found.', 'Download Sales-ScOrders(_GET_FLAT_FILE_ALL_ORDERS_DATA_BY_ORDER_DATE_)', 'app\Console\Commands\Mws\screports\ScOrders.php');
                    ...
                    foreach ($getMwsDoneReportsArray as $index) {
                        ...
                        Log::info("filePath:app\Console\Commands\Mws\screports\ScOrders.php.Download Sales-ScOrders(_GET_FLAT_FILE_ALL_ORDERS_DATA_BY_ORDER_DATE_). Api Call Starts.(Report Id:'.$report_id.')");
                        MWSModel::insert_mws_Activity('Api Call Starts.', 'Download Sales-ScOrders(_GET_FLAT_FILE_ALL_ORDERS_DATA_BY_ORDER_DATE_)(Report Id:'.$report_id.')', 'app\Console\Commands\Mws\screports\ScOrders.php');
                        ...
                        if (!empty($report_data)) {
                            Log::info("filePath:app\Console\Commands\Mws\screports\ScOrders.php.Download Sales-ScOrders(_GET_FLAT_FILE_ALL_ORDERS_DATA_BY_ORDER_DATE_). Data Found In Api.(Report Id:'.$report_id.')");
                            MWSModel::insert_mws_Activity('Data Found In Api.', 'Download Sales-ScOrders(_GET_FLAT_FILE_ALL_ORDERS_DATA_BY_ORDER_DATE_)(Report Id:'.$report_id.')', 'app\Console\Commands\Mws\screports\ScOrders.php');
                            ...
                            foreach ($report_data as $insert_record) {
                                ...
                                // MWSModel::insert_mws_ScOrdersReport($data);
                                //array_push($insert_data_array, $data);
                                $result=MWSModel::insert_mws_ScOrdersReport($data);

                            }
                            /*if (!empty($insert_data_array)) {
                                MWSModel::insert_mws_ScOrdersReport($insert_data_array);
                            }*/
                            $acknowledgement = MWSModel::update_mws_report_acknowledgement($fk_request_id, 'true');

                            if ($acknowledgement) {
                                Log::info("filePath:app\Console\Commands\Mws\screports\ScOrders.php.Download Sales-ScOrders(_GET_FLAT_FILE_ALL_ORDERS_DATA_BY_ORDER_DATE_). Report Acknowledge In Database.(Report Id:'.$report_id.')");
                                MWSModel::insert_mws_Activity('Report Acknowledge In Database.', 'Download Sales-ScOrders(_GET_FLAT_FILE_ALL_ORDERS_DATA_BY_ORDER_DATE_)(Report Id:'.$report_id.')', 'app\Console\Commands\Mws\screports\ScOrders.php');

                            } else {
                                Log::info("filePath:app\Console\Commands\Mws\screports\ScOrders.php.Download Sales-ScOrders(_GET_FLAT_FILE_ALL_ORDERS_DATA_BY_ORDER_DATE_). Report Not Acknowledge In Database.(Report Id:'.$report_id.')");
                                MWSModel::insert_mws_Activity('Report Not Acknowledge In Database.', 'Download Sales-ScOrders(_GET_FLAT_FILE_ALL_ORDERS_DATA_BY_ORDER_DATE_)(Report Id:'.$report_id.')', 'app\Console\Commands\Mws\screports\ScOrders.php');
                            }
                        } else {
                            $acknowledgement = MWSModel::update_mws_report_acknowledgement($fk_request_id, 'no_data');
                            Log::info("filePath:app\Console\Commands\Mws\screports\ScOrders.php.Download Sales-ScOrders(_GET_FLAT_FILE_ALL_ORDERS_DATA_BY_ORDER_DATE_). Data Not Found In Api.(Report Id:'.$report_id.')");
                            MWSModel::insert_mws_Activity('Data Not Found In Api.', 'Download Sales-ScOrders(_GET_FLAT_FILE_ALL_ORDERS_DATA_BY_ORDER_DATE_)(Report Id:'.$report_id.')', 'app\Console\Commands\Mws\screports\ScOrders.php');
                        }
                    }
                } else {
                    Log::info("filePath:app\Console\Commands\Mws\screports\ScOrders.php.Download Sales-ScOrders(_GET_FLAT_FILE_ALL_ORDERS_DATA_BY_ORDER_DATE_). Done Reports Not Found.");
                    MWSModel::insert_mws_Activity('Done Reports Not Found.', 'Download Sales-ScOrders(_GET_FLAT_FILE_ALL_ORDERS_DATA_BY_ORDER_DATE_)', 'app\Console\Commands\Mws\screports\ScOrders.php');
                }

            }
        } else {
            Log::info("filePath:app\Console\Commands\Mws\screports\ScOrders.php.Download Sales-ScOrders(_GET_FLAT_FILE_ALL_ORDERS_DATA_BY_ORDER_DATE_). Merchants Not Found.");
            MWSModel::insert_mws_Activity('Merchants Not Found.', 'Download Sales-ScOrders(_GET_FLAT_FILE_ALL_ORDERS_DATA_BY_ORDER_DATE_)', 'app\Console\Commands\Mws\screports\ScOrders.php');
        }
        Log::info("filePath:app\Console\Commands\Mws\screports\ScOrders.php.Download Sales-ScOrders(_GET_FLAT_FILE_ALL_ORDERS_DATA_BY_ORDER_DATE_). End Cron.");
        MWSModel::insert_mws_Activity('End Cron.', 'Download Sales-ScOrders(_GET_FLAT_FILE_ALL_ORDERS_DATA_BY_ORDER_DATE_)', 'app\Console\Commands\Mws\screports\ScOrders.php');
    }
}
