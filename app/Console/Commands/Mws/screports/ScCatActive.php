...
class ScCatActive extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'ScCatActivereport:cron';
    ...
    {
        Log::info("filePath:app\Console\Commands\Mws\screports\ScCatActivereport.php.Download Inventory-ScCatActivereport(_GET_MERCHANT_LISTINGS_DATA_). Start Cron.");
        MWSModel::insert_mws_Activity('Start Cron', 'Download Inventory-ScCatActivereport(_GET_MERCHANT_LISTINGS_DATA_)', 'app\Console\Commands\Mws\screports\ScCatActivereport.php');
        $APIParametr = new MWSModel();
        $api_data = $APIParametr->get_merchants();
        if ($api_data) {
            Log::info("filePath:app\Console\Commands\Mws\screports\ScCatActivereport.php.Download Inventory-ScCatActivereport(_GET_MERCHANT_LISTINGS_DATA_). Merchants Found.");
            MWSModel::insert_mws_Activity('Merchants Found.', 'Download Inventory-ScCatActivereport(_GET_MERCHANT_LISTINGS_DATA_)', 'app\Console\Commands\Mws\screports\ScCatActivereport.php');
            foreach ($api_data as $api_parameter) {
                ...
                $getMwsDoneReportsArray = MWSModel::get_mws_done_reports('_GET_MERCHANT_LISTINGS_DATA_', $mws_config_id, 'Inventory');
                if ($getMwsDoneReportsArray) {
                    Log::info("filePath:app\Console\Commands\Mws\screports\ScCatActivereport.php.Download Inventory-ScCatActivereport(_GET_MERCHANT_LISTINGS_DATA_). Done Reports Found.");
                    MWSModel::insert_mws_Activity('Done Reports Found.', 'Download Inventory-ScCatActivereport(_GET_MERCHANT_LISTINGS_DATA_)', 'app\Console\Commands\Mws\screports\ScCatActivereport.php');
                    foreach ($getMwsDoneReportsArray as $index) {
                        ...
                        $amz->fetchReport();
                        $path = '';
                        Log::info("filePath:app\Console\Commands\Mws\screports\ScCatActivereport.php.Download Inventory-ScCatActivereport(_GET_MERCHANT_LISTINGS_DATA_). Api Call Starts.(Report Id:'.$report_id.')");
                        MWSModel::insert_mws_Activity('Api Call Starts.', 'Download Inventory-ScCatActivereport(_GET_MERCHANT_LISTINGS_DATA_)(Report Id:'.$report_id.')', 'app\Console\Commands\Mws\screports\ScCatActivereport.php');
                        $report_data = $amz->saveReport($path);
                        if (!empty($report_data)) {
                            Log::info("filePath:app\Console\Commands\Mws\screports\ScCatActivereport.php.Download Inventory-ScCatActivereport(_GET_MERCHANT_LISTINGS_DATA_).Data Found In Api.(Report Id:'.$report_id.')");
                            MWSModel::insert_mws_Activity('Data Found In Api.', 'Download Inventory-ScCatActivereport(_GET_MERCHANT_LISTINGS_DATA_)(Report Id:'.$report_id.')', 'app\Console\Commands\Mws\screports\ScCatActivereport.php');
                            ...
                            foreach ($report_data as $insert_record) {
                                ...
                                // MWSModel::insert_mws_ScCatActiveReport($data);
                            ...
                            /*if (!empty($insert_data_array)) {
                                MWSModel::insert_mws_ScCatActiveReport($insert_data_array);
                            }*/
                            $acknowledgement = MWSModel::update_mws_report_acknowledgement($fk_request_id, 'true');
                            if ($acknowledgement) {
                                Log::info("filePath:app\Console\Commands\Mws\screports\ScCatActivereport.php.Download Inventory-ScCatActivereport(_GET_MERCHANT_LISTINGS_DATA_).Report Acknowledge In Database.(Report Id:'.$report_id.')");
                                MWSModel::insert_mws_Activity('Report Acknowledge In Database.', 'Download Inventory-ScCatActivereport(_GET_MERCHANT_LISTINGS_DATA_)(Report Id:'.$report_id.')', 'app\Console\Commands\Mws\screports\ScCatActivereport.php');
                            } else {
                                Log::info("filePath:app\Console\Commands\Mws\screports\ScCatActivereport.php.Download Inventory-ScCatActivereport(_GET_MERCHANT_LISTINGS_DATA_).Report Not Acknowledge In Database.(Report Id:'.$report_id.')");
                                MWSModel::insert_mws_Activity('Report Not Acknowledge In Database.', 'Download Inventory-ScCatActivereport(_GET_MERCHANT_LISTINGS_DATA_)(Report Id:'.$report_id.')', 'app\Console\Commands\Mws\screports\ScCatActivereport.php');
                            }
                        } else {
                            $acknowledgement = MWSModel::update_mws_report_acknowledgement($fk_request_id, 'no_data');
                            Log::info("filePath:app\Console\Commands\Mws\screports\ScCatActivereport.php.Download Inventory-ScCatActivereport(_GET_MERCHANT_LISTINGS_DATA_).No Data Found In Api.(Report Id:'.$report_id.')");
                            MWSModel::insert_mws_Activity('No Data Found In Api.', 'Download Inventory-ScCatActivereport(_GET_MERCHANT_LISTINGS_DATA_)(Report Id:'.$report_id.')', 'app\Console\Commands\Mws\screports\ScCatActivereport.php');
                        }
                    }

                } else {
                    Log::info("filePath:app\Console\Commands\Mws\screports\ScCatActivereport.php.Download Inventory-ScCatActivereport(_GET_MERCHANT_LISTINGS_DATA_). Done Reports Not Found.");
                    MWSModel::insert_mws_Activity('Done Reports Not Found.', 'Download Inventory-ScCatActivereport(_GET_MERCHANT_LISTINGS_DATA_)', 'app\Console\Commands\Mws\screports\ScCatActivereport.php');
                }

            }

        } else {
            Log::info("filePath:app\Console\Commands\Mws\screports\ScCatActivereport.php.Download Inventory-ScCatActivereport(_GET_MERCHANT_LISTINGS_DATA_). Merchants Not Found.");
            MWSModel::insert_mws_Activity('Merchants Not Found.', 'Download Inventory-ScCatActivereport(_GET_MERCHANT_LISTINGS_DATA_)', 'app\Console\Commands\Mws\screports\ScCatActivereport.php');
        }

        Log::info("filePath:app\Console\Commands\Mws\screports\ScCatActivereport.php.Download Inventory-ScCatActivereport(_GET_MERCHANT_LISTINGS_DATA_). End Cron.");
        MWSModel::insert_mws_Activity('End Cron.', 'Download Inventory-ScCatActivereport(_GET_MERCHANT_LISTINGS_DATA_)', 'app\Console\Commands\Mws\screports\ScCatActivereport.php');
