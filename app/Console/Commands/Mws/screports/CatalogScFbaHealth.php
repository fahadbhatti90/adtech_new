...
class CatalogScFbaHealth extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'CatalogScFbaHealth:cron';
    ...
    {
        Log::info("filePath:app\Console\Commands\Mws\screports\CatalogScFbaHealth.php.Download Catalog-CatalogScFbaHealth(_GET_FBA_FULFILLMENT_INVENTORY_HEALTH_DATA_). Start Cron.");
        MWSModel::insert_mws_Activity('Start Cron', 'Download Catalog-CatalogScFbaHealth(_GET_FBA_FULFILLMENT_INVENTORY_HEALTH_DATA_)', 'app\Console\Commands\Mws\screports\CatalogScFbaHealth.php');

        $APIParametr = new MWSModel();
        $api_data = $APIParametr->get_merchants();

        if ($api_data) {
            Log::info("filePath:app\Console\Commands\Mws\screports\CatalogScFbaHealth.php.Download Catalog-CatalogScFbaHealth(_GET_FBA_FULFILLMENT_INVENTORY_HEALTH_DATA_). Merchants Found.");
            MWSModel::insert_mws_Activity('Merchants Found.', 'Download Catalog-CatalogScFbaHealth(_GET_FBA_FULFILLMENT_INVENTORY_HEALTH_DATA_)', 'app\Console\Commands\Mws\screports\CatalogScFbaHealth.php');
            foreach ($api_data as $api_parameter) {
                ...
                $getMwsDoneReportsArray = MWSModel::get_mws_done_reports('_GET_FBA_FULFILLMENT_INVENTORY_HEALTH_DATA_', $mws_config_id, 'Catalog');
                if ($getMwsDoneReportsArray) {
                    Log::info("filePath:app\Console\Commands\Mws\screports\CatalogScFbaHealth.php.Download Catalog-CatalogScFbaHealth(_GET_FBA_FULFILLMENT_INVENTORY_HEALTH_DATA_). Done Reports Found.");
                    MWSModel::insert_mws_Activity('Merchants Found.', 'Download Catalog-CatalogScFbaHealth(_GET_FBA_FULFILLMENT_INVENTORY_HEALTH_DATA_)', 'app\Console\Commands\Mws\screports\CatalogScFbaHealth.php');
                    foreach ($getMwsDoneReportsArray as $index) {
                        ...
                        $amz->fetchReport();
                        Log::info("filePath:app\Console\Commands\Mws\screports\CatalogScFbaHealth.php.Download Catalog-CatalogScFbaHealth(_GET_FBA_FULFILLMENT_INVENTORY_HEALTH_DATA_). Done Reports Found.(Report Id:'.$report_id.')");
                        MWSModel::insert_mws_Activity('Done Reports Found.', 'Download Catalog-CatalogScFbaHealth(_GET_FBA_FULFILLMENT_INVENTORY_HEALTH_DATA_)(Report Id:'.$report_id.')', 'app\Console\Commands\Mws\screports\CatalogScFbaHealth.php');
                        $path = '';
                        $report_data = $amz->saveReport($path);

                        if (!empty($report_data)) {
                            Log::info("filePath:app\Console\Commands\Mws\screports\CatalogScFbaHealth.php.Download Catalog-CatalogScFbaHealth(_GET_FBA_FULFILLMENT_INVENTORY_HEALTH_DATA_). Data Found In Api.(Report Id:'.$report_id.')");
                            MWSModel::insert_mws_Activity('Data Found In Api.', 'Download Catalog-CatalogScFbaHealth(_GET_FBA_FULFILLMENT_INVENTORY_HEALTH_DATA_)(Report Id:'.$report_id.')', 'app\Console\Commands\Mws\screports\CatalogScFbaHealth.php');
                            ...
                            foreach ($report_data as $insert_record) {
                                ...
                                // MWSModel::insert_mws_CatalogScFbaHealthReport($data);
                                $data['createdAt'] = date('Y-m-d H:i:s');
                                //array_push($insert_data_array, $data);
                                MWSModel::insert_mws_CatalogScFbaHealthReport($data);
                            }
                            /*if (!empty($insert_data_array)) {
                                MWSModel::insert_mws_CatalogScFbaHealthReport($insert_data_array);
                            }*/
                            Log::info("filePath:app\Console\Commands\Mws\screports\CatalogScFbaHealth.php.Download Catalog-CatalogScFbaHealth(_GET_FBA_FULFILLMENT_INVENTORY_HEALTH_DATA_). Data Found In Api.(Report Id:'.$report_id.')");
                            MWSModel::insert_mws_Activity('Data Found In Api.', 'Download Catalog-CatalogScFbaHealth(_GET_FBA_FULFILLMENT_INVENTORY_HEALTH_DATA_)(Report Id:'.$report_id.')', 'app\Console\Commands\Mws\screports\CatalogScFbaHealth.php');
                            $acknowledgement = MWSModel::update_mws_report_acknowledgement($fk_request_id, 'true');
                            if ($acknowledgement) {
                                Log::info("filePath:app\Console\Commands\Mws\screports\CatalogScCatActivereport.php.Download Catalog-ScCatActivereport(_GET_MERCHANT_LISTINGS_DATA_). Report Acknowledge In Database.(Report Id:'.$report_id.')");
                            ...
                            Log::info("filePath:app\Console\Commands\Mws\screports\CatalogScFbaHealth.php.Download Catalog-CatalogScFbaHealth(_GET_FBA_FULFILLMENT_INVENTORY_HEALTH_DATA_). No Data Found In Api.(Report Id:'.$report_id.')");
                            MWSModel::insert_mws_Activity('No Data Found In Api.', 'Download Catalog-ScCatActivereport(_GET_MERCHANT_LISTINGS_DATA_)(Report Id:'.$report_id.')', 'app\Console\Commands\Mws\screports\CatalogScFbaHealth.php');
                        }
                    }
                } else {
                    Log::info("filePath:app\Console\Commands\Mws\screports\CatalogScFbaHealth.php.Download Catalog-CatalogScFbaHealth(_GET_FBA_FULFILLMENT_INVENTORY_HEALTH_DATA_)). No done reports found in db.");
                    MWSModel::insert_mws_Activity('No done reports found in db.', 'Download Catalog-CatalogScFbaHealth(_GET_FBA_FULFILLMENT_INVENTORY_HEALTH_DATA_)', 'app\Console\Commands\Mws\screports\CatalogScFbaHealth.php');
                }
            }
        }

        Log::info("filePath:app\Console\Commands\Mws\screports\CatalogScFbaHealth.php.Download Catalog-CatalogScFbaHealth(_GET_FBA_FULFILLMENT_INVENTORY_HEALTH_DATA_)). End Cron");
        MWSModel::insert_mws_Activity('End Cron', 'Download Catalog-CatalogScFbaHealth(_GET_FBA_FULFILLMENT_INVENTORY_HEALTH_DATA_)', 'app\Console\Commands\Mws\screports\CatalogScFbaHealth.php');
