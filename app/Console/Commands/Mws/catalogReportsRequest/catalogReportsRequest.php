...
namespace App\Console\Commands\Mws\catalogReportsRequest;
...
class catalogReportsRequest extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'catalogReportsRequest:cron';
    ...
    {
        Log::info("filePath:app\Console\Commands\Mws\catalogReportsRequest.Request Catalog Report. Start Cron.");
        MWSModel::insert_mws_Activity('Catalog Report RequestStart Cron', 'Catalog Report Request', 'app\Console\Commands\Mws\catalogReportsRequest');
        ...
        if ($api_data) {
            ...
            Log::info("filePath:app\Console\Commands\Mws\catalogReportsRequest. Merchants Found.");
            MWSModel::insert_mws_Activity('Merchants Found.', 'Catalog Report Request', 'app\Console\Commands\Mws\catalogReportsRequest');
                ...
                if ($check_sc_account_exist > 0) {
                    ...
                    if ($get_sc_account_id) {
                        ...
                        if ($sc_count_batch_id > 0) {
                            ...
                            //$report_types=array('_GET_MERCHANT_LISTINGS_DATA_','_GET_MERCHANT_LISTINGS_INACTIVE_DATA_','_GET_FBA_FULFILLMENT_INVENTORY_HEALTH_DATA_');
                            $report_types = [
                            ...
                            foreach ($report_types as $report_types) {
                                ...
                                if ($count_mws_existing_reports && $count_mws_existing_reports > 0) {
                                    ...
                                    $duplicate_requerst['metricsType'] = 'Catalog';
                                    $duplicate_requerst['fk_merchant_id'] = trim($check_mws_existing_reports[0]->fk_merchant_id);
                                    ...
                                    if ($result_insert_duplicate_report) {
                                        Log::info("filePath:app\Console\Commands\Mws\catalogReportsRequest. Request Records Inserted.(Report Type:'.$report_types.')");
                                        MWSModel::insert_mws_Activity('Request Records Inserted.', 'Catalog Report Request(Report Type:' . $report_types . ')', 'app\Console\Commands\Mws\catalogReportsRequest');
                                    } else {
                                        Log::info("filePath:app\Console\Commands\Mws\catalogReportsRequest. Request Records Not Inserted.(Report Type:'.$report_types.')");
                                        MWSModel::insert_mws_Activity('Request Records Not Inserted.(Report Type:' . $report_types . ')', 'Catalog Report Request', 'app\Console\Commands\Mws\catalogReportsRequest');
                                    }
                                } else {
                                    ...
                                    $amz->requestReport();
                                    Log::info("filePath:app\Console\Commands\Mws\catalogReportsRequest. Api Call Starts.(Report Type:'.$report_types.')");
                                    MWSModel::insert_mws_Activity('Api Call Starts.', 'Catalog Report Request(Report Type:' . $report_types . ')', 'app\Console\Commands\Mws\catalogReportsRequest');
                                    $report_request_data = $amz->getResponse();
                                    if ($report_request_data) {
                                        Log::info("filePath:app\Console\Commands\Mws\catalogReportsRequest. Data Found In Api.(Report Type:'.$report_types.')");
                                        MWSModel::insert_mws_Activity('Data Found In Api.', 'Catalog Report Request(Report Type:' . $report_types . ')', 'app\Console\Commands\Mws\catalogReportsRequest');
                                        ...
                                        $report_request_data['metricsType'] = 'Catalog';
                                        ...
                                        if ($result_insert_report) {
                                            ...
                                            Log::info("filePath:app\Console\Commands\Mws\catalogReportsRequest. Request Records Not Inserted.(Report Type:'.$report_types.')");
                                            MWSModel::insert_mws_Activity('Request Records Not Inserted.', 'Catalog Report Request(Report Type:' . $report_types . ')', 'app\Console\Commands\Mws\catalogReportsRequest');
                                        }
                                        //exit;
                                    } else {
                                        Log::info("filePath:app\Console\Commands\Mws\catalogReportsRequest. No Data Found In Api.(Report Type:'.$report_types.')");
                                        MWSModel::insert_mws_Activity('No Data Found In Api.', 'Catalog Report Request(Report Type:' . $report_types . ')', 'app\Console\Commands\Mws\catalogReportsRequest');
                                    }
                                }
                            }
                        } else {
            ...
            Log::info("filePath:app\Console\Commands\Mws\catalogReportsRequest. Merchants Not Found.");
            MWSModel::insert_mws_Activity('Merchants Not Found.', 'Catalog Report Request', 'app\Console\Commands\Mws\catalogReportsRequest');
        }
        Log::info("filePath:app\Console\Commands\Mws\catalogReportsRequest.Request Catalog Report. End Cron.");
        MWSModel::insert_mws_Activity('End Cron.', 'Catalog Report Request', 'app\Console\Commands\Mws\catalogReportsRequest');
    }
}
