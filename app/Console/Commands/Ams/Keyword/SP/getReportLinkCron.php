...
use App\Models\ams\Report\Link\Keyword\SP\KeywordSPModel;
...
class getReportLinkCron extends Command
{
     ...
     * @var string
     */
    protected $signature = 'getkeywordreportlink:spkeyword {day?}';
    ...
    public function handle()
    {
        ...
        if ($AllProfileID->isNotEmpty()) {
            foreach ($AllProfileID as $single) {
                ...
                $existReport = KeywordSPModel::where('profileID', $profileID)
