...
use App\Models\ams\Report\Link\Campaign\SB\CampaignSBModel;
...
class getReportLinkCron extends Command
{
     ...
     * @var string
     */
    protected $signature = 'getcampaignreportlink:sbcampaign {day?}';
    ...
    public function handle()
    {
        ...
        if ($AllProfileID->isNotEmpty()) {
            foreach ($AllProfileID as $single) {
                ...
                $existReport = CampaignSBModel::where('profileID', $profileID)
                    ...
                    if (!empty($body) && $body != null) {
                        ...
                        switch ($reportLinkStatus) {
                            case "FAILURE":
                                ...
                                break;
                            default:
                                $reportLink = new CampaignSBModel();
