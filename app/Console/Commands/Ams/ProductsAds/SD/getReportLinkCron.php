...
use App\Models\ams\Report\Link\ProductsAds\SD\ProductsAdsSDModel;
...
class getReportLinkCron extends Command
{
     ...
     * @var string
     */
    protected $signature = 'getsdproductsadsreportlink:sdproductsads {day?}';
    ...
    public function handle()
    {
        ...
        if ($AllProfileID->isNotEmpty()) {
            foreach ($AllProfileID as $single) {
                ...
                $existReport = ProductsAdsSDModel::where('profileID', $profileID)
                    ...
                    if (!empty($body) && $body != null) {
                        ...
                        switch ($reportLinkStatus) {
                            case "FAILURE":
                                ...
                                break;
                            default:
                                $reportLink = new ProductsAdsSDModel();
