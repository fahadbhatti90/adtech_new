...
use App\Models\ams\Report\Link\ASIN\ASINModel;
...
class getReportLinkCron extends Command
{
     ...
     * @var string
     */
    protected $signature = 'getasinreportlink:asinreport {day?}';
    ...
    public function handle()
    {
        ...
        if ($AllProfileID->isNotEmpty()) {
            foreach ($AllProfileID as $single) {
                ...
                $existReport = ASINModel::where('profileID', $profileID)
