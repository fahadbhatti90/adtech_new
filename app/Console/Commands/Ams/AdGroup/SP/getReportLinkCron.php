...
use App\Models\ams\Report\Link\Adgroup\SP\AdgroupSPModel;
...
class getReportLinkCron extends Command
{
     ...
     * @var string
     */
    protected $signature = 'getadgroupreportlink:spadgroup {day?}';
    ...
    public function handle()
    {
        ...
        if ($AllProfileID->isNotEmpty()) {
            foreach ($AllProfileID as $single) {
                ...
                $existReport = AdgroupSPModel::where('profileID', $profileID)
