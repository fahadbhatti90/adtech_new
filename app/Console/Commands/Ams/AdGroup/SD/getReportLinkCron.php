...
use App\Models\ams\Report\Link\Adgroup\SD\AdgroupSDModel;
...
class getReportLinkCron extends Command
{
     ...
     * @var string
     */
    protected $signature = 'getsdadgroupreportlink:sdadgroup {day?}';
    ...
    public function handle()
    {
        ...
        if ($AllProfileID->isNotEmpty()) {
            foreach ($AllProfileID as $single) {
                ...
                $existReport = AdgroupSDModel::where('profileID', $profileID)
