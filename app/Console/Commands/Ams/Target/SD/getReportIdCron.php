...
class getReportIdCron extends Command
{
     ...
     * @var string
     */
    protected $signature = 'gettargetreportid:sdtargets {day?}';
     ...
     * @var string
     */
    protected $description = 'This command is used to get Target SD reportId.';
    ...
    {
        Log::info("filePath:Commands\Ams\Target\SD\getReportIdCron. Start Cron.");
        ...
        if ($AllProfileID->isNotEmpty()) {
            ...
            foreach ($AllProfileID as $single) {
                ...
                $url = Config::get('constants.amsApiUrl') . '/' . Config::get('constants.targetsReportSd');
                ...
                try {
                    ...
                    $response = $client->request('POST', $url, [
                        ...
                        'json' => [
                            ...
                            'metrics' => Config::get('constants.sdTargetingMetrics')],
        ...
        Log::info("filePath:Commands\Ams\Target\SD\getReportIdCron. End Cron.");
    }
}
