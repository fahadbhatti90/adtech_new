...
use App\Models\ams\Report\Link\Target\SB\TargetAdsSBModel;
...
class getReportLinkCron extends Command
{
     ...
     * @var string
     */
    protected $signature = 'gettargetreportlink:sbtargets {day?}';
    ...
    public function handle()
    {
        ...
        if ($AllProfileID->isNotEmpty()) {
            foreach ($AllProfileID as $single) {
                ...
                $existReport = TargetAdsSBModel::where('profileID', $profileID)
                    ...
                    if (!empty($body) && $body != null) {
                        ...
                        switch ($reportLinkStatus) {
                            case "FAILURE":
                                ...
                                break;
                            default:
                                $reportLink = new TargetAdsSBModel();
