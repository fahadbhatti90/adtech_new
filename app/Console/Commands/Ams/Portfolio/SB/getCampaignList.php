...
class getCampaignList extends Command
{
     ...
     * @var string
     */
    protected $signature = 'getSandBoxSBCampaignlist:portfolio';
     ...
     * @var string
     */
    protected $description = 'This Command is used to get Day partying Sponsored Brand Campaign List';
            ...
            foreach ($allProfileIds as $single) {
                ...
                try {
                    ...
                    if ($ex->getCode() == 401) {
                        ...
                        AMSModel::insertTrackRecord('SB Day partying getCampaignList 503. profile id:' . $profileId . ' and number try is: ' . $try, '503');
                        sleep(Config::get('constants.sleepTime') + 5);
                        goto b;
                    }
                    // store report status
                    AMSModel::insertTrackRecord('App\Console\Commands\Ams\Portfolio\SB\getSBCampaignlist and error code :'.$ex->getCode(), 'fail');
