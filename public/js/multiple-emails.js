(function ($) {
    ...
    $.fn.multiple_emails = function (options) {
        ...
        if (settings.theme.toLowerCase() == "Bootstrap".toLowerCase()) {
            deleteIconHTML = '<a href="#" class="multiple_emails-close" title="Remove"><i class="fas fa-minus-circle"></i></a>';
        ...
        return this.each(function () {
            ...
            var $input = $('<input type="text" class="multiple_emails-input text-left " placeholder="Enter cc email list"/>').on('keyup', function (e) { // input
