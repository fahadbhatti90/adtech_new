document.addEventListener('DOMContentLoaded', function(e) {
    ...
    $('#addScheduleFormModel').on('hidden.bs.modal', function (e) {
         ...
         $(".addClientModel .modal-title").text("Associate Brand");
    ...
    const fv = FormValidation.formValidation(form, {
            ...
            brandId = $("#addAccountForm #brandId").val();
...
//alert($("#addAccountForm #managerId").val());
  //          return false;


            DatatoUpload.append("brandId",brandId);
            DatatoUpload.append("managerId",$("#addAccountForm #managerId").val());
        ...
        $("table tbody").on('click','i.fa-trash',function (e) {
            ...
            console.log(base_url+'/ht/'+rowID+'/deleteBrandAssociation/')
            Swal.fire({
                ...
                preConfirm: (ddetails) => {
                    ...
                    return fetch(base_url+'/ht/'+rowID+'/deleteBrandAssociation/', {
                        method: 'DELETE',
                        headers: {
