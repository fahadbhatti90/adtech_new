        ...
        <div class="container-fluid clientDasboard ">
            ...
            <div class="row noSpace options">
                ...
                <div class="col-xl-12 col-md-12  mb-3">
                    <div class="card left_card shadow h-100 materializeCss">
                        <div class="cardTitleCustom">Filters</div>
                        <div class="card-body">
                           @include('partials.graphsPreloader')
                           
                            <div class="row no-gutters align-items-center graphFilter">
                                <div class="col col-lg-3 col-md-5 col-sm-12 col-12 mr-3 ml-0">
                                    ...
                                    <select class="mdb-select md-form category">
                                        ...
                                        @isset($categories)`
                                            @foreach ($categories as $key=>$category)
                                                ...
                                                <option value="{{ $category->category_id }}">{{ (($category->category_alias != null && count($category->category_alias) > 0) ? ($category->category_alias[0]->overrideLabel == null ? $category->category_name : $category->category_alias[0]->overrideLabel) : $category->category_name) }}</option>
                                            @endforeach
                                        @endisset
                                    </select>
                                </div>
                                ...
                                <div class="col col-lg-3 col-md-5 col-sm-12 col-12 mr-0 asinParent">
                                    <select class="mdb-select md-form asin">
                                        <option value="" disabled >Select Product (ASIN)</option>
                                    </select> 
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-12 col-md-12 mb-4">
                    <div class="card right_card shadow h-100 materializeCss">
                        <div class="card-body">
                           @include('partials.graphsPreloader')
                                ...
                                <div class="col py-4 mr-4 ml-4"> 
                                        <div class="datesFilter row text-md-center text-sm-center text-xl-center" defaultMonth="{{ $defaultMonth }}" defaultYear="@isset($availableYears[0]) {{ $availableYears[0]->availableYear }} @else NA @endisset">
                                            ...
                                            <div class="col-lg-2 col-md-2 col-sm-12">
                                                <span class="selectedAsin badge"  title="No ASIN Found" activeyear="@isset($availableYears[0]) {{ $availableYears[0]->availableYear }} @else NA @endisset"></span>
                                                <div class="tooltip_templates">
                                                    <span id="selectedToolTipContent">
            ...
            <div class="row noSpace productPreviewTable materializeCss">
                <!-- Earnings (Monthly) Card Example -->
                <div class="col-xl-12 col-md-12 mb-4">
...
@push('js')
	...
	<script src="{{asset('public/vendor/d3v4/d3v4.min.js')}}"></script>
