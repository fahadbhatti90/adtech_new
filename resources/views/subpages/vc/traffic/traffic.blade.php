...
@section('content')
    ...
    @push('daterangepickerjs')
        ...
        <script src="{{asset('public/js/vc_scripts/traffic.js?'.time())}}"></script>
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card shadow mb-4">
                    ...
                    <!-- Card Body -->
                    <div class="card-body">
                        <form id="trafficFormId" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                <label for="traffic">Upload</label>
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" name="traffic_upload_file">
                                    <label class="custom-file-label" for="traffic">Choose File</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="dateRange">Select Start & End Date Range</label>
