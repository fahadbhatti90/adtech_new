...
@section('content')
    ...
    @push('daterangepickerjs')
        ...
        <script src="{{asset('public/js/vc_scripts/daily_sales.js?'.time())}}"></script>
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12">
                ...
                <!-- Card Header - Dropdown -->
                    ...
                    <!-- Card Body -->
                    <div class="card-body">
                        <form id="dailySalesFormId" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="form-group">
                            <label for="daily-sales">Upload</label>
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" name="daily_sales">
                                <label class="custom-file-label" for="daily-sales">Choose File</label>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="upload-file-date">Date</label>
                            <input type="text" name="daily_sales_date" value="{{ old('daily_sales_date') }}"
                                   class="form-control date" placeholder="mm/dd/yyyy" autocomplete="off">
                        </div>
