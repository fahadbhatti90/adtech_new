...
@section('content')
    ...
    @push('daterangepickerjs')
        ...
        <script src="{{asset('public/js/vc_scripts/product_catalog.js?'.time())}}"></script>
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12">
                ...
                <div class="card shadow mb-4">
                    ...
                    <!-- Card Body -->
                    <div class="card-body">
                        <form id="productCatalogFormId" enctype="multipart/form-data">
                            ...
                            <div class = "form-group">
                                <label for = "catalog">Upload</label>
                                <div class="custom-file">
                                    <input type = "file" class = "custom-file-input"  name="catalog_upload_file">
                                    <label class="custom-file-label" for="catalog">Choose File</label>
                                </div>
                            </div>
                            <div class = "form-group">
                                <label for = "catalog-start-date">Date</label>

                                <input type = "text" name="catalog_date" class = "form-control date"
