...
import {
    BID_MULTIPLIER_CAMPAIGN_HISTORY_DELETE_DATA_URL} from '../../apiCalls';
class DeleteBidMultiplier extends Component {
    constructor(props){
        super(props);
        this.state = {
            isProcessing:false
    ...
    handleDeleteFormSubmit = () => {
        ...
        deleteItem(BID_MULTIPLIER_CAMPAIGN_HISTORY_DELETE_DATA_URL+this.props.id, ()=>{
...
export default connect(null)(DeleteBidMultiplier)
