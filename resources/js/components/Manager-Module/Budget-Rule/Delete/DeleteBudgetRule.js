...
import {deleteBudgetRule} from "../apiCalls";

class DeleteBudgetRule extends Component {
    constructor(props){
        super(props);
        this.state = {
            isProcessing:false
    ...
    handleDeleteFormSubmit = () => {
        ...
        deleteBudgetRule(params, (data) => {

            if (data.status){
                this.props.handleModalClose();
                this.props.dispatch(ShowSuccessMsg("Successfull", "Budget Rule deleted successfully", true, "",this.props.updateDataTableAfterSubmit()));
            }else{
...
export default connect(null)(DeleteBudgetRule)
