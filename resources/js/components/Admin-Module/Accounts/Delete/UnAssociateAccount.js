...
import {UnAssociateAccountApiCall} from './apiCalls';
class UnAssociateAccount extends Component {
    constructor(props){
        super(props);
        this.state = {
            isProcessing:false
    ...
    handleUnAssociateAccountSubmit = () => {
        this.setState({isProcessing:true})
        UnAssociateAccountApiCall({
            id:this.props.id
        }, (response)=>{
        ...
        return (
            ...
            <div className="relative">
                <div className="flex float-right items-center justify-center w-full">
                    Do you really want to Un-Associate Account?
                </div>
                <div className="flex float-right items-center justify-center my-5 mt-8 w-full">
                        ...
                        <PrimaryButton
                            btnlabel={"Confirm"}
                            variant={"contained"}
                            onClick={this.handleUnAssociateAccountSubmit}
                        />     
                </div>
            </div>
            </>
...
export default connect(null)(UnAssociateAccount)
