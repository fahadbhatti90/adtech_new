...
export const productTitleRowHandler = (row, clickHandler, classes) =>{
    ...
    onClick={newProductTitle == "None" ? ()=>{} : clickHandler}
...
export const subCategoryRowHandler = (row,clickHandler, classes)=>{
    ...
    let tooltipTarget = <div
    onClick={newSubCategory == "None" ? ()=>{} : clickHandler} 
    type="4" 
...
export const brandRowHandler = (row,clickHandler, classes)=>{
...
export const getTableColumns = (itemsToShow, handleOnColumnClick, classes) => {
    let cols = [
        {
            name: 'ASIN',
            selector: 'ASIN',
        ...
        }, 
        {
            ...
            sortable: true,
            wrap: true,
            cell: row => subCategoryRowHandler(row, handleOnColumnClick, classes)
        }, 
        {
            name: 'Category Name',
            ...
            sortable: true,
            wrap: true,
            cell: row => categoryRowHandler(row, handleOnColumnClick, classes)
        }, 
        {
            name: 'Brand Name',
            ...
            sortable: true,
            wrap: true,
            cell: row => brandRowHandler(row, handleOnColumnClick, classes)
        }
    ]
    let NewCols = [];
