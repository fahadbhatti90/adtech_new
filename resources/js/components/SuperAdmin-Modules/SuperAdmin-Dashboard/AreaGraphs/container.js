...
import Graph from '../AreaGraphs/AreaGraph';
...
import "../HealthDashboard/HealthDashboard.scss";
        ...
        <>
            <Card classes={{ root: classes.card }} className={`mt-6 relative ${props.customClass?props.customClass:""}`}>  
                ...
                <CardHeader
                    ...
                    heading={
                        <div>
                            Report ID mandatory verses Report ID for current date
                            { props.data.length > 0 ?
                                <HealthDashboardTooltip
                                    tooltipContent={
                                        <Card className="overflow-hidden healthDashbaordToolTipTables" classes={{root: classes.tableCard}}>
                                            <div className="font-semibold mb-3 ml-3 mt-2 w-4/12">Report Id Errors</div>
