...
return [
    ...
    */
    ...
    'aliases' => [
        ...
        'HelperFunctions' => App\Libraries\HelperFunctions::class,
        'ScraperConstant' => App\Libraries\ScraperConstant::class,
    ...
    'debug_blacklist' => [
        '_ENV' => [
            ...
            'CUSTOM_MAIL_CHARSET',
            'CUSTOM_MAIL_SMTP_AUTH',
            'CUSTOM_MAIL_SMTP_ENCRIPTION',
            'CUSTOM_MAIL_HOST',
            'CUSTOM_MAIL_PORT',
            'CUSTOM_MAIL_USERNAME',
            'CUSTOM_MAIL_PASSWORD',
            'CUSTOM_MAIL_FROM_NAME',
            'CUSTOM_MAIL_FROM_EMAIL',
        ],
        '_SERVER' => [
            'APP_NAME',
            'APP_ENV',
