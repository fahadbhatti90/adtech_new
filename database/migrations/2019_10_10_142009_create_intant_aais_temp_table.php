...
class CreateIntantAaisTempTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_asins_intant_temp_urls', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_asins_intant_temp_urls');
    }
}
