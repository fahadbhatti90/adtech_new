...
class CreateAmsAsinReportsDownloadLinks extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_ams_asin_reports_download_links', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_ams_asin_reports_download_links');
    }
}
