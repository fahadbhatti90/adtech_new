...
class CreateAmsProductsadsReportsDownloadedData extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_ams_productsads_reports_downloaded_data', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_ams_productsads_reports_downloaded_data');
    }
}
