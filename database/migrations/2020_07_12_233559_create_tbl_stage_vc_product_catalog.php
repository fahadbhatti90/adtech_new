...
class CreateTblStageVcProductCatalog extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_stage_vc_product_catalog', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_stage_vc_product_catalog');
    }
}
