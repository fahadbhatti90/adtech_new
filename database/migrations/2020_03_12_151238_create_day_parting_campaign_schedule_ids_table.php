...
class CreateDayPartingCampaignScheduleIdsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_ams_day_parting_campaign_schedule_ids', function (Blueprint $table) {
            $table->bigInteger('fkScheduleId');
            $table->bigInteger('fkCampaignId');
    ...
    {
        Schema::dropIfExists('tbl_ams_day_parting_campaign_schedule_ids');
    }
}
