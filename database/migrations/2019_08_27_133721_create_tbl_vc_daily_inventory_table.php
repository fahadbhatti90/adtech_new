...
class CreateTblVcDailyInventoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_vc_daily_inventory', function (Blueprint $table) {
            ...
            //$table->string('str_sellable_on_hand_inventory', 50);
            $table->double('sellable_on_hand_inventory', 20, 2);
            //$table->string('str_sellable_on_hand_inventory_trailing_30_day_average', 100);
            $table->double('sellable_on_hand_inventory_trailing_30_day_average', 20,2);
            $table->bigInteger('sellable_on_hand_units');
            //$table->string('str_sellable_on_hand_units', 50);
            //$table->string('str_unsellable_on_hand_inventory', 50);
            $table->double('unsellable_on_hand_inventory', 20, 2);
            //$table->string('str_unsellable_on_hand_inventory_trailing_30_day_average', 100);
            $table->double('unsellable_on_hand_inventory_trailing_30_day_average', 20,2);
            //$table->string('str_unsellable_on_hand_units', 100);
    ...
    {
        Schema::dropIfExists('tbl_vc_daily_inventory');
    }
}
