...
class TblSccatactivereport extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_sc_inventory_cat_active_report', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_sc_inventory_cat_active_report');
    }
}
