...
class CreateSpAmsPopulateLinkError extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        DB::connection("mysql")->unprepared("DROP procedure IF EXISTS spAMSPopulateLinkError");
        DB::connection("mysql")->unprepared("CREATE PROCEDURE `spAMSPopulateLinkError`(in start_date varchar(50))
        BEGIN
