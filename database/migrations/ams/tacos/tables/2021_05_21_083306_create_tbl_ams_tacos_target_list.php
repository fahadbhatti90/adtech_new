...
class CreateTblAmsTacosTargetList extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_ams_tacos_target_list', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_ams_tacos_target_list');
    }
}
