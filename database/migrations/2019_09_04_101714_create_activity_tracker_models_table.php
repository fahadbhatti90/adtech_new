...
class CreateActivityTrackerModelsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_scraping_activity_tracker', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('tbl_scraping_activity_tracker');
    }
}
