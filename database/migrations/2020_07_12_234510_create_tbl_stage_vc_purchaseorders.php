...
class CreateTblStageVcPurchaseorders extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_stage_vc_purchaseorders', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_stage_vc_purchaseorders');
    }
}
