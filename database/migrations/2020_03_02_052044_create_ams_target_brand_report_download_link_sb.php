...
class CreateAmsTargetBrandReportDownloadLinkSb extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_ams_targets_reports_downloaded_data_sb', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->bigInteger('fkBatchId');
            $table->bigInteger('fkAccountId');
            $table->string('fkReportsDownloadLinksId', 50);
            ...
            $table->string('targetingExpression');
            $table->string('targetingText');
    ...
    {
        Schema::dropIfExists('tbl_ams_targets_reports_downloaded_data_sb');
    }
}
