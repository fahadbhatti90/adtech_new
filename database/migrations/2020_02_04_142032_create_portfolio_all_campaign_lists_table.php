...
class CreatePortfolioAllCampaignListsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_ams_day_parting_portfolio_all_campaign_lists', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_ams_day_parting_portfolio_all_campaign_lists');
    }
}
