...
class CreateAmsTargetsReportsDownloadedData extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_ams_targets_reports_downloaded_data', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_ams_targets_reports_downloaded_data');
    }
}
