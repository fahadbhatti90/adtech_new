...
class CreateTblSearchRankFailStatuses extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_search_rank_fail_statuses', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_search_rank_fail_statuses');
    }
}
