...
class CreateTblVcDailyForecastTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_vc_daily_forecast', function (Blueprint $table) {
            ...
            //$table->foreign('fk_vendor_id')->references('vendor_id')->on('tbl_vc_vendors', 50);
    ...
    {
        Schema::dropIfExists('tbl_vc_daily_forecast');
    }
}
