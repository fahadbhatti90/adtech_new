...
class CreateAmsAdgroupReportsDownloadedDataSp extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_ams_adgroup_reports_downloaded_data_sp', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_ams_adgroup_reports_downloaded_data_sp');
    }
}
