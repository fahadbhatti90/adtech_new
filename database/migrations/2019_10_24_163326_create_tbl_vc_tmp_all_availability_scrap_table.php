...
class CreateTblVcTmpAllAvailabilityScrapTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_vc_tmp_all_availability_scrap', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_vc_tmp_all_availability_scrap');
    }
}
